...
kqllet ntlm_logons = SecurityEvent
| where EventID == 4624
| where LogonType == 3
| where AuthenticationPackageName == "NTLM"
...
kql// Rule Name: Pass-the-Hash Lateral Movement Detection
// Severity: High
...
Maintained by @Junaidpk07 — Last validated: May 2025
